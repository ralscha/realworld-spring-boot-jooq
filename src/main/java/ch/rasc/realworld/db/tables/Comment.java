...
public class Comment extends TableImpl<CommentRecord> {
     ...
     */
    public final TableField<CommentRecord, String> BODY = createField(DSL.name("body"), SQLDataType.CLOB.nullable(false), this, "");
     ...
     */
    public final TableField<CommentRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>comment.updated_at</code>.
     */
    public final TableField<CommentRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Long, ? super String, ? super Long, ? super Long, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Long, ? super String, ? super Long, ? super Long, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
