...
public class Follow extends TableImpl<FollowRecord> {
     ...
     */
    public final TableField<FollowRecord, Long> USER_ID = createField(DSL.name("user_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>follow.follow_id</code>.
     */
    public final TableField<FollowRecord, Long> FOLLOW_ID = createField(DSL.name("follow_id"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     * the <code>fk_follow_user</code> key.
     */
    ...
    /**
     * Get the implicit join path to the <code>PUBLIC.app_user</code> table, via
     * the <code>fk_follow_follow_user</code> key.
     */
