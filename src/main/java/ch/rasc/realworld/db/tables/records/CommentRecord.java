...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record6<Long, String, Long, Long, OffsetDateTime, OffsetDateTime> {
    ...
    @Override
    public CommentRecord values(Long value1, String value2, Long value3, Long value4, OffsetDateTime value5, OffsetDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(Long id, String body, Long articleId, Long userId, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        super(Comment.COMMENT);
