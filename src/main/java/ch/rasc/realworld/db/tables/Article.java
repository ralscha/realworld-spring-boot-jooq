...
public class Article extends TableImpl<ArticleRecord> {
     ...
     */
    public final TableField<ArticleRecord, String> SLUG = createField(DSL.name("slug"), SQLDataType.VARCHAR(255).nullable(false), this, "");
     ...
     */
    public final TableField<ArticleRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>article.body</code>.
     */
    public final TableField<ArticleRecord, String> BODY = createField(DSL.name("body"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>article.created_at</code>.
     */
    public final TableField<ArticleRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>article.updated_at</code>.
     */
    public final TableField<ArticleRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
