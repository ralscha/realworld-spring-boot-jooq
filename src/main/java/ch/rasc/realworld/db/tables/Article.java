...
public class Article extends TableImpl<ArticleRecord> {
	...
	public List<ForeignKey<ArticleRecord, ?>> getReferences() {
		return Arrays.asList(Keys.CONSTRAINT_FF2);
	}
	...
	public <U> SelectField<U> mapping(
			Function8<? super Long, ? super Long, ? super String, ? super String, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
