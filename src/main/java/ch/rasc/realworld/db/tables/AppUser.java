...
public class AppUser extends TableImpl<AppUserRecord> {
	...
	private static final long serialVersionUID = 197284148;
	 ...
	 */
	public final TableField<AppUserRecord, String> PASSWORD = createField("PASSWORD",
			org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
	 ...
	 */
	public final TableField<AppUserRecord, String> BIO = createField("BIO",
			org.jooq.impl.SQLDataType.CLOB, this, "");

	/**
	 * The column <code>APP_USER.IMAGE</code>.
	 */
	public final TableField<AppUserRecord, String> IMAGE = createField("IMAGE",
			org.jooq.impl.SQLDataType.VARCHAR(511), this, "");
	...
	public List<Index> getIndexes() {
		return Arrays.<Index>asList(Indexes.CONSTRAINT_INDEX_7,
				Indexes.CONSTRAINT_INDEX_76, Indexes.PRIMARY_KEY_7);
	}
	...
	public List<UniqueKey<AppUserRecord>> getKeys() {
		return Arrays.<UniqueKey<AppUserRecord>>asList(Keys.CONSTRAINT_7,
				Keys.CONSTRAINT_76, Keys.CONSTRAINT_760);
	}
